...
* [2. 开始](#二、开始)
    * [2.1 支持平台](#21-支持平台)
    * [2.2 下载Slime](#22-下载-slime)
        * [2.2.1 从CVS下载](#221-从-cvs-下载)
        * [2.2.2 使用CVS](#222-使用-cvs)
    * [2.3 安装](#23-安装)
    * [2.4 启动Slime](#24-启动-slime)
    * [2.5 调整设置](#25-调整设置)
        * [2.5.1 自动加载](#251-自动加载)
        * [2.5.2 多种Lisp](#252-多种-lisp)
        * [2.5.3 更快地加载Swank](#253-更快地加载-swank)

* [3. 使用 Slime 模式](#三、使用-slime-模式)
    * [3.1 用户介面须知](#31-用户介面须知)
        * [3.1.1 临时缓冲区](#311-临时缓冲区)
        * [3.1.2 `inferior-lisp`缓冲区](#312-inferior-lisp缓冲区)
        * [3.1.3 多线程](#313-多线程)
        * [3.1.4 键绑定](#314-键绑定)
    * [3.2 求值命令](#32-求值命令)
    * [3.3 编译命令](#33-编译命令)
    * [3.4 补全命令](#34-补全命令)
    * [3.5 查找定义（“Meta-Point”命令）](#35-查找定义（“meta-point”命令）)
    * [3.6 文档命令](#36-文档命令)
    * [3.7 交叉引用命令](#37-交叉引用命令)
        * [3.7.1 XREF 缓冲区命令](#371-xref缓冲区命令)
    * [3.8 宏扩展命令](#38-宏扩展命令)
    * [3.9 分解命令](#39-分解命令)
    * [3.10 中止/恢复命令](#310-中止恢复命令)
    * [3.11 检查命令](#311-检查命令)
    * [3.12 分析命令](#312-分析命令)
    * [3.13 遮盖命令](#313-遮盖命令)
    * [3.14 语义缩进](#314-语义缩进)
    * [3.15 根据读取器的结果字符化](#315-根据读取器的结果字符化)

* [4. SLDB：Slime 调试器](#四、sldb：slime调试器)
    * [4.1 检查窗口](#41-检查窗口)
    * [4.2 重启](#42-重启)
    * [4.3 在不同的窗口间操作](#43-在不同的窗口间操作)
    * [4.4 单步调试](#44-单步调试)
    * [4.5 其它命令](#45-其它命令)
...
* [6. 定制](#六、定制)
    * [6.1 Emacs 端定制](#61-emacs端定制)
        * [6.1.1 钩子](#611-钩子)
    * [6.2 Lisp 端（Swank）](#62-lisp端（swank）)
        * [6.2.1 通信模式](#621-通信模式)
        * [6.2.2 其它配置](#622-其它配置)

* [7. 小技巧](#七、小技巧)
    * [7.1 连接到远程 Lisp](#71-连接到远程lisp)
        * [7.1.1 设置 Lisp 镜像](#711-设置lisp镜像)
        * [7.1.2 设置 Emacs](#712-设置emacs)
        * [7.1.3 设置路径名翻译](#713-设置路径名翻译)
    * [7.2 重定向全局 IO 到 REPL](#72-重定向全局io到repl)
    * [7.3 自动连接到 Slime](#73-自动连接到slime)

* [8. 扩展包](#八、扩展包)
    * [8.1 加载扩展包](#81-加载扩展包)
    * [8.2 REPL：“顶层环境”](#82-repl：“顶层环境”)
        * [8.2.1 REPL命令](#821-repl命令)
        * [8.2.2 输入引导](#822-输入引导)
        * [8.2.3 快捷命令](#823-快捷命令)
    * [8.3 多REPL](#83-多repl)
    ...
    * [8.9 导航条](#89-导航条)
    * [8.10 编辑命令](#810-编辑命令)
    * [8.11 更好的检查器](#811-更好的检查器)
    * [8.12 对象描述](#812-对象描述)
    * [8.13 打印窗口](#813-打印窗口)
    * [8.14 TRAMP](#814-tramp)
    * [8.15 文档链接](#815-文档链接)
    * [8.16 交叉引用和类查看器](#816-交叉引用和类查看器)
    * [8.17 高亮编辑](#817-高亮编辑)
    * [8.18 空白缓冲区](#818-空白缓冲区)
    * [8.19 slime-sprof](#819-slime-sprof)
    * [8.20 元包 slime-fancy](#820-元包-slime-fancy)
